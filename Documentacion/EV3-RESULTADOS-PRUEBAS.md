...
|----|--------|---------------|-------------------|--------|-----------|
| CP-01 | Auth | Login exitoso familia | Redirección a `/dashboard` con Panel de Familia (apoderada sin institución propia) | OK | Captura-01 |
...
| CP-10 | Equipo | Educador ve obs. familia | `eduardoaltavida@email.com` ve observaciones PUBLICA de familia en Matías Pérez con autor visible | OK | Captura-10 |
...
| CP-10 | Obs. familia en perfil Matías Pérez | Login `eduardoaltavida@email.com` + bitácora | Ve obs. PUBLICA de familia | Cumple | OK | Captura-10 |
