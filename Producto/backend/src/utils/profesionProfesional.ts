...
/** Catálogo de profesiones para usuarios con rol PROFESIONAL (centro terapéutico / salud). */
...
export const profesionProfesionalSchema = z.enum(PROFESIONES_PROFESIONAL);
...
export const profesionalEquipoBodySchema = z.object({
  especialidad: profesionProfesionalSchema
});
